...
# ============================================================
# 2. Função robusta para converter datas
# ============================================================
...
# ============================================================
# 4. Função MERGE com hash dinâmico (essa função já elimina duplicados)
# ============================================================
def merge_rows(df, table, columns, converters=None):
    ...
    if "hash" not in df.columns:
        ...
        # Orçado vs Realizado
            ...
            raise Exception(f"Não sei como gerar hash para a tabela {table}.")
    ...
    print(f"➡️ Processando MERGE na tabela {table}...")

    for _, row in df.iterrows():
        cursor.execute(merge_sql, *(row[col] for col in columns))

    conn.commit()
    print(f"✅ MERGE concluído para {table}!")
...
print("\n✅ Todos os dados foram processados com MERGE e estão atualizados no SQL Server!")
